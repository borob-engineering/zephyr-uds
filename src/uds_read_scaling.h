...
/**
 * @file
 * @brief Public interface definitions for the UDS Read Scaling Data module (Service 0x24).
 */

#ifndef ZEPHYR_SRC_UDS_READ_SCALING_H_
#define ZEPHYR_SRC_UDS_READ_SCALING_H_
...
/**
 * @brief Central request handler for UDS Service 0x24 (Read Scaling Data By Identifier).
 *
...
#endif /* ZEPHYR_SRC_UDS_READ_SCALING_H_ */
